...
- Brand: colors, type and logo come from the LunarCrush design system (green `#14B881`, blue `#6EA6F8`, canvas `#0B121E`, Plus Jakarta Sans, white mark). The retired purple palette is not used anywhere.
